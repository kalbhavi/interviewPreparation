...
*/
/* Find how many left shifts are required to prepare a mask, which will result in left most bit position,
   if we AND the mask with both given numbers */

int bitwiseAndToFindNumberRange(int m, int n) {
    unsigned int mask = ~0;
